...
// Model for Departments entity
    models.Departments = Backbone.Model.extend({
        urlRoot: "http://localhost:8084/CollegeRecords/webresources/entity.departments/",
        ...
        toViewJson: function () {
            ...
            result.displayName = this.get('departmentId');
            return result;
        },
        isNew: function () {
        ...
        sync: function (method, model, options) {
            ...
            if (method === 'create') {
                options.url = 'http://localhost:8084/CollegeRecords/webresources/entity.departments/';
            }
    ...
    models.DepartmentsCollection = Backbone.Collection.extend({
        ...
        url: "http://localhost:8084/CollegeRecords/webresources/entity.departments/",
        sync: function (method, model, options) {
            options || (options = {});
            var errorHandler = {
                error: function (jqXHR, textStatus, errorThrown) {
    ...
    var AppRouter = Backbone.Router.extend({
            ...
            this.collection.fetch({
                success: function () {
                    self.listView = new views.ListView({
                        ...
                        // tpl-departments-list-itemis template identifier for item
        ...
        details: function (id) {
            if (this.collection) {
                ...
                this.view = new views.ModelView({
                    ...
                    // tpl-departments-details is template identifier for chosen model element
        ...
        create: function () {
            ...
            this.view = new views.ModelView({
                ...
                // tpl-departments-details is a template identifier for chosen model element
                templateName: '#tpl-departments-details',
