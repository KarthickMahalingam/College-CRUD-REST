...
public class DepartmentsFacadeREST extends AbstractFacade<Departments> {
    ...
    //@PersistenceContext(unitName = "CollegeRecordsPU")
    //Persistence.createEntityManagerFactory("CollegeRecordsPU").createEntityManager();
    ...
    protected EntityManager getEntityManager() {
        em=Persistence.createEntityManagerFactory("CollegeRecordsPU").createEntityManager();
        return em;
    }
